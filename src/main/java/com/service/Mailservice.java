...
public class Mailservice {
	...
	public void sendWelcomeEmailTemplate(String to, String firstName) throws MessagingException {
		...
		String htmlContent = "<!DOCTYPE html>" + "<html>" + "<head>"
				+ "    <title>Welcome to Evalution Portal Created By Jalp Panchal</title>" + "    <style>"
				...
				+ "<body>" + "    <h2>Welcome to Our Evalution Portal, " + firstName + "!</h2>" + "    <p>Hi "
				+ firstName + ",</p>"
		...
		helper.setTo(to);
		helper.setSubject("Welcome to Evalution Portal, " + firstName + "!");
